...
%
% Ejecuta LIME para el sistema cooperativo 3-MG.
%
% ** ACTUALIZACIÓN: Acepta TARGET_MG_IDX para definir qué variable explicar.
%--------------------------------------------------------------------------
function [all_explanations, feature_names] = calculate_lime_stability_3mg(estado, controller_obj, params, NUM_EXECUTIONS, TARGET_MG_IDX)
    ...
    for run_idx = 1:NUM_EXECUTIONS
        ...
        % C. Y-Scaler (Específico para TARGET_MG_IDX)
        ...
        fprintf('    Entrenando Y-Scaler para MG%d...\n', TARGET_MG_IDX);
