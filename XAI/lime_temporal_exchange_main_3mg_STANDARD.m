...
for t_idx = TARGETS
    ...
    for idx = 1:length(k_list)
        ...
        [lime_stats, all_explanations] = calculate_lime_exchange_3mg_STANDARD_MOMENTS(estado, controller_obj, params, NUM_RUNS_PER_POINT, t_idx);
