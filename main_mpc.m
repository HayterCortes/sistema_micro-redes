...
% --- MODIFICACIÓN: Se capturan los sets de validación para crear el historial de arranque ---
...
% --- MODIFICACIÓN: Preparar el historial de arranque desde el set de validación ---
max_lags = 48; 
...
% --- MODIFICACIÓN: Se pasa el 'hist_arranque' a la función de simulación ---
